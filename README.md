...
VITE_AUTH_SERVICE_URL=http://localhost:4001/api/auth
VITE_MESSAGE_SERVICE_URL=http://localhost:4002/api/messages
VITE_USER_SERVICE_URL=http://localhost:4003/api/users
